...
fulano[0:3] # O python trabalha com intervalo aberto, neste caso, não irá pegar o último elemento
# por isso não irá acessar o estado civil
...
salario = fulano[5]
salario[::-1]
# Fulano[ start : stop : step] -> step: indica como será o comportamento de percorrer a lista
